...
##### Goal
The goal of this project is to present how to use **web.xml** file in a **GUI HTML Java** application with usage **Java EE 9** framework. Application is deployed on **payara micro** in version 6.
