...
##### Goal
The goal of this project is to present how to create **index** file in a **plain GUI JSP Java** application with usage **Java EE 9** framework. Application is deployed on **payara micro** in version 6.
