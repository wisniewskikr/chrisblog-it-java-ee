...
##### Goal
The goal of this project is to present how to connect **REST API Java** application with **H2 embedded database** using **Java EE 8** framework. This application returns JSON with the key "message" and the value **Hello World!** as the result of GET HTTP method. 
