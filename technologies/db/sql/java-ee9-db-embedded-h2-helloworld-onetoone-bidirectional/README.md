...
##### Goal
The goal of this project is to present how to use **bidirectional @OneToOne** annotation in a **REST API** application related to **embedded H2** database using **Java** programming language and **Java EE 9** framework. Application is deployed on a server **payara micro** in version 6.

##### Terminology
Terminology explanation:
* **Bidirectional @OneToOne**: this annotation enables connecting two entities in relation one to one - one first entity is related to only one second entity. Bidirectional means that we can start from first entity to get second entity and opposite way
