...
##### Goal
The goal of this project is to present how to use **@Embedded** annotation in a **REST API** application related to **embedded H2** database using **Java** programming language and **Java EE 9** framework. Application is deployed on a server **payara micro** in version 6.

##### Terminology
Terminology explanation:
* **@Embedded**: this annotation enables including some class into Entities. This class has to be annotated as @Embedable and contains only one field
