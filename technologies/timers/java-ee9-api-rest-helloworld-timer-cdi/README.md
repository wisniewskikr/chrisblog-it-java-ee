...
##### Goal
The goal of this project is to present how to implement **timer** using class **ManagedScheduledExecutorService** in **REST API Java** application using **Java EE 9** framework. Application is deployed on **payara micro** in version 6.

Class **ManagedScheduledExecutorService** enables running some method in some specific time periods.
